...
ACTOR_ML: Dict[str, Dict[str, str]] = {
    ...
    "united states (centcom)": {"en": "United States (CENTCOM)", "ko": "미국(중부사령부)", "es": "EE.UU. (CENTCOM)", "zh": "美国（中央司令部）", "ja": "米国（中央軍）", "fr": "É.-U. (CENTCOM)", "de": "USA (CENTCOM)"},
    ...
    "hezbollah (iran proxy)": {"en": "Hezbollah (Iran proxy)", "ko": "헤즈볼라(이란 대리세력)", "es": "Hezbolá (proxy de Irán)", "zh": "真主党（伊朗代理）", "ja": "ヒズボラ（イラン代理）", "fr": "Hezbollah (proxy iranien)", "de": "Hisbollah (Iran-Stellvertreter)"},
    "oman (mediator)": {"en": "Oman (mediator)", "ko": "오만(중재국)", "es": "Omán (mediador)", "zh": "阿曼（调解方）", "ja": "オマーン（仲介)", "fr": "Oman (médiateur)", "de": "Oman (Vermittler)"},
