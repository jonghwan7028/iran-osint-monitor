...
MEANS_KO: dict[str, str] = {
    ...
    "drone": "드론",
    "missiles": "미사일",
    "missiles, drones": "미사일·드론",
    "drones, ballistic missiles": "드론·탄도미사일",
    ...
    "suicide drones": "자폭 드론",
    "suicide boat swarm": "자폭 고속정 군집공격",
    ...
    "anti-ship ballistic missiles, suicide drones": "대함 탄도미사일·자폭 드론",
    "succession / appointment": "승계·임명",
    "succession": "승계",
    "appointment": "임명",
    "threat of attack": "공격 위협",
