...
_GLOSSARY: dict[str, dict[str, str]] = {
    ...
    "osint": {
        ...
        "name_ko": "공개 정보 수집(OSINT)",
        "name_en": "Open Source Intelligence",
        "desc_ko": "인터넷, 언론, 공공 데이터베이스 등 공개된 출처에서 정보를 수집하고 분석하는 지능 활동. 위성영상, 뉴스 기사, 소셜 미디어 등이 주요 소스다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/공개정보활동",
        "wiki_en": "https://en.wikipedia.org/wiki/Open-source_intelligence",
    },
    "humint": {
        "category": "methodology",
        "name_ko": "인적 정보 수집(HUMINT)",
        "name_en": "Human Intelligence",
        "desc_ko": "인간의 직접적인 관찰, 접촉, 침투를 통해 수집하는 정보. 스파이, 밀정, 첩보원 등을 활용한다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/휴민트",
        "wiki_en": "https://en.wikipedia.org/wiki/Human_intelligence",
    },
    "sigint": {
        "category": "methodology",
        "name_ko": "신호 정보 수집(SIGINT)",
        "name_en": "Signals Intelligence",
        "desc_ko": "무선통신, 전자신호, 통신 내용 감청 등을 통해 수집하는 정보. 국방부, NSA, GCHQ 같은 국가 정보기관이 주로 운영한다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/신호정보",
        "wiki_en": "https://en.wikipedia.org/wiki/Signals_intelligence",
    },
    "geoint": {
        "category": "methodology",
        "name_ko": "지리공간 정보 수집(GEOINT)",
        "name_en": "Geospatial Intelligence",
        "desc_ko": "위성영상, 항공사진, 레이더 등 공간정보 기술을 통해 수집·분석하는 정보. 시설 추적, 군사 배치 확인 등에 사용된다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/지리정보수집",
        "wiki_en": "https://en.wikipedia.org/wiki/Geospatial_intelligence",
    },
    "escalation": {
        "category": "geopolitics",
        "name_ko": "확전",
        "name_en": "Escalation",
        "desc_ko": "분쟁의 강도, 참가 국가 수, 사용 무기의 위력 등이 증대되는 현상. 군사 충돌 → 전쟁으로의 급속한 확대를 의미한다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/갈등_확대",
        "wiki_en": "https://en.wikipedia.org/wiki/Escalation_of_commitment",
    },
    "deterrence": {
        "category": "geopolitics",
        "name_ko": "억제 / 억지",
        "name_en": "Deterrence",
        "desc_ko": "군사력의 우월성을 바탕으로 상대방의 공격을 사전에 방지하거나 보복 능력을 과시하여 위협을 완화하는 전략. 핵억지(mutual assured destruction)가 대표 사례다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/억지_(안보)",
        "wiki_en": "https://en.wikipedia.org/wiki/Deterrence",
    },
    "proportional response": {
        "category": "geopolitics",
        "name_ko": "비례적 대응",
        "name_en": "Proportional Response",
        "desc_ko": "상대방의 공격 또는 도발에 대해 비슷한 수준의 대응을 하는 군사 전략. 과도한 보복을 피하고 충돌 확대를 제한하려는 의도에서 사용된다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/상호억제",
        "wiki_en": "https://en.wikipedia.org/wiki/Proportional_response",
    },
    "rules of engagement": {
        "category": "geopolitics",
        "name_ko": "교전규칙",
        "name_en": "Rules of Engagement",
        "desc_ko": "군사 작전 중 군인들이 언제, 어디서, 어떻게 무력을 사용할 수 있는지를 규정하는 규범. 국제법, 전쟁 윤리, 정치적 고려사항을 반영한다.",
        "wiki_ko": "https://ko.wikipedia.org/wiki/교전규칙",
        "wiki_en": "https://en.wikipedia.org/wiki/Rules_of_engagement",
    },
}
